...
class OppoGateway extends Gateway
{
    ...
    public function pushNotice($to, AbstractMessage $message, array $options = [])
    {
        $messageData = [
            ...
            'click_action_type' => $message->extra['oppo']['click_action_type']??0,
            'click_action_activity' => $message->extra['oppo']['click_action_activity'] ?? null,
            'click_action_url' => $message->extra['oppo']['click_action_url'] ?? null,
            'action_parameters' => $message->extra['oppo']['action_parameters'] ?? null,
